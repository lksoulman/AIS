...
type
  TGPGraphics = class;
  {$NODEFINE TGPGraphics}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPGraphics;'}
  TGPPen = class;
  {$NODEFINE TGPPen}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPPen;'}
  TGPBrush = class;
  {$NODEFINE TGPBrush}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPBrush;'}
  TGPMatrix = class;
  {$NODEFINE TGPMatrix}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPMatrix;'}
  TGPBitmap = class;
  {$NODEFINE TGPBitmap}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPBitmap;'}
  TGPMetafile = class;
  {$NODEFINE TGPMetafile}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPMetafile;'}
  TGPFontFamily = class;
  {$NODEFINE TGPFontFamily}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPFontFamily;'}
  TGPGraphicsPath = class;
  {$NODEFINE TGPGraphicsPath}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPGraphicsPath;'}
  TGPRegion = class;
  {$NODEFINE TGPRegion}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPRegion;'}
  TGPImage = class;
  {$NODEFINE TGPImage}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPImage;'}
  TGPHatchBrush = class;
  {$NODEFINE TGPHatchBrush}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPHatchBrush;'}
  TGPSolidBrush = class;
  {$NODEFINE TGPSolidBrush}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPSolidBrush;'}
  TGPLinearGradientBrush = class;
  {$NODEFINE TGPLinearGradientBrush}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPLinearGradientBrush;'}
  TGPPathGradientBrush = class;
  {$NODEFINE TGPPathGradientBrush}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPPathGradientBrush;'}
  TGPFont = class;
  {$NODEFINE TGPFont}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPFont;'}
  TGPFontCollection = class;
  {$NODEFINE TGPFontCollection}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPFontCollection;'}
  TGPInstalledFontCollection = class;
  {$NODEFINE TGPInstalledFontCollection}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPInstalledFontCollection;'}
  TGPPrivateFontCollection = class;
  {$NODEFINE TGPPrivateFontCollection}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPPrivateFontCollection;'}
  TGPImageAttributes = class;
  {$NODEFINE TGPImageAttributes}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPImageAttributes;'}
  TGPCachedBitmap = class;
  {$NODEFINE TGPCachedBitmap}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPCachedBitmap;'}
  TGPCustomLineCap = class;
  {$NODEFINE TGPCustomLineCap}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPCustomLineCap;'}
  TGPTextureBrush = class;
  {$NODEFINE TGPTextureBrush}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPTextureBrush;'}
  TGPStringFormat = class;
  {$NODEFINE TGPStringFormat}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPStringFormat;'}
  TGPGraphicsPathIterator = class;
  {$NODEFINE TGPGraphicsPathIterator}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPGraphicsPathIterator;'}
  TGPAdjustableArrowCap = class;
  {$NODEFINE TGPAdjustableArrowCap}
  {$HPPEMIT 'class PASCALIMPLEMENTATION TGPAdjustableArrowCap;'}
...
var
   ...
   {$EXTERNALSYM GenericSansSerifFontFamily}
   GenericSerifFontFamily     : TGPFontFamily = nil;
   {$EXTERNALSYM GenericSerifFontFamily}
   GenericMonospaceFontFamily : TGPFontFamily = nil;
   {$EXTERNALSYM GenericMonospaceFontFamily}

   GenericTypographicStringFormatBuffer: TGPStringFormat = nil;
   {$EXTERNALSYM GenericTypographicStringFormatBuffer}
   GenericDefaultStringFormatBuffer    : TGPStringFormat = nil;
   {$EXTERNALSYM GenericDefaultStringFormatBuffer}

   StartupInput: TGDIPlusStartupInput;
   {$EXTERNALSYM StartupInput}
   gdiplusToken: ULONG;
   {$EXTERNALSYM gdiplusToken}
...
\**************************************************************************)
  ...
  function TGPFontCollection.GetFamilies(numSought: Integer; out gpfamilies: array of TGPFontFamily;
      out numFound: Integer): TStatus;
  type
    TArrGpFontFamily = array of GpFontFamily;
  var
    nativeFamilyList: TArrGpFontFamily;
    Status: TStatus;
    i: Integer;
  begin
