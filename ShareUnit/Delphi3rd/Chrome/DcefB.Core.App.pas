...
begin
  //在这里进行退出操作，解决有些情况子进程不退出的问题 --add by sgao 2017-06-14
...
begin
  ...
  //开启一个站点一个进程的模式  add by sgao 2017-06-12
  commandLine.AppendSwitch('process-per-site');
  //关闭GPU合成，解决开多个页面卡死的问题  add by sgao 2017-06-12
...
//以下语句在TContext.Destroy里面做，可以解决子进程无法退出的问题。 --add by sgao 2017-06-14
//InnerDcefBResourceBundleHandler := nil;
//InnerDcefBBrowserProcessHandler := nil;
//InnerDcefBRenderProcessHandler := nil;
//InnerCefOnBeforeCommandLineProcessing := nil;
