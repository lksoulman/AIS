...
{$IFEND}
  ...
  PFocusedNodeChangedArgs = ^TFocusedNodeChangedArgs;
  PExternalFuncArgs = ^TExternalFuncArgs;
  ...
  //add by sgao 2017-06-10 焦点节点改变消息参数
  TFocusedNodeChangedArgs = record
    frame: PICefFrame;
    isEditable: Boolean;
  end;

  //add by sgao 2017-06-19 外部函数执行消息参数
  TExternalFuncArgs = record
    functName: Pustring;
    params: Pustring;
  end;
