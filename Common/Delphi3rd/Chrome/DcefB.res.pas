...
Const
  ...
  //add by sgao 2017-06-10  焦点节点改变消息
  WM_FocusedNodeChanged = WM_USER + 53;
  //add by sgao 2017-06-19  外部函数执行消息
  WM_ExternalFuncExec = WM_USER + 54;
...
Const
  ...
  //add by sgao 2017-06-14  渲染进程发出的焦点改变消息
  RENDERPROCESS_FOCUSEDNODE_CHANGED_MSG = '@RenderProcess_FocusedNode_Changed';
  //add by sgao 2017-06-14  渲染进程发出的外部函数消息
  RENDERPROCESS_EXTERNAL_FUNC_MSG = '@RenderProcess_EXTERNAL_FUNC';
